...
export default function Searchtab() {
    ...
    const [endofEventTime, setEndofEventTime] = useState('');
    const [startofEventTime, setStartofEventTime] = useState('');
    ...
    const handlesubmit = async (e) => {
        e.preventDefault();
        const blog = { facilityName, startofEventTime, endofEventTime };
                        ...
                        <div id='row-adf'>
                            <div className='date-facility'>
                                ...
                                <input
                                    ...
                                    value={startofEventTime}
                                    required
                                    onChange={(e) =>
                                        setStartofEventTime(e.target.value)
                                    }
                                />
                            </div>
                            ...
                            <div className='date-facility'>
                                ...
                                <input
                                    ...
                                    name='appt'
                                    // value="2023-11-24T19:30"
                                    value={endofEventTime}
                                    required
                                    onChange={(e) =>
                                        setEndofEventTime(e.target.value)
                                    }
                                />
                            </div>
